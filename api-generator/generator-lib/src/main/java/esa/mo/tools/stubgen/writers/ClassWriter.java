...
public interface ClassWriter extends LanguageWriter {
     ...
     */
    void addClassOpenStatement(String className, boolean finalClass,
            boolean abstractClass, String extendsClass,
            String implementsInterface, String comment) throws IOException;
     ...
     * @throws IOException If there is an IO error.
     */
    void addClassVariable(boolean isStatic, boolean isFinal, String scope,
            CompositeField type, boolean isObject, String initialValue) throws IOException;
    ...
    void addClassVariable(boolean isStatic, boolean isFinal, String scope,
            ...
            List<String> initialValue) throws IOException;
     ...
     * @throws IOException If there is an IO error.
     */
    void addStaticConstructor(String returnType, String methodName,
            String args, String constructorCall) throws IOException;
     ...
     * @throws IOException If there is an IO error.
     */
    MethodWriter addConstructor(String scope, String className,
            CompositeField arg, boolean isArgForSuper, String throwsSpec,
            String comment, String throwsComment) throws IOException;
     ...
     */
    MethodWriter addConstructor(String scope, String className,
            List<CompositeField> args, List<CompositeField> superArgs,
     ...
     * @param returnComment The comment for the return value.
     * @param throwsComment The comment for the throws specification.
     * @param isDeprecated Is the method deprecated
     * @return Returns a method writer for the method.
     * @throws IOException If there is an IO error.
     */
    MethodWriter addMethodOpenStatement(boolean isFinal, boolean isVirtual,
