...
//    logger.setLevel (Level.WARNING);
  ...
  {
    public void send(Report _Report0, MALInteraction interaction) throws MALInteractionException, MALException
    {
    }

    public void send2(org.ccsds.moims.mo.xml.test.Report body0, MALInteraction interaction) throws MALInteractionException, MALException
    {
    }

    public Report request(Report body0, MALInteraction interaction) throws MALInteractionException, MALException
    {
      return body0;
    }
  }
