...
public class Archive
{
   ...
   * @param rtrObjectType Object Type to be checked against can include wildcards
   ...
   *
   * @param rtrObjectType Object Type of objects to be retrieved can contain wildcards
   * @param rtrDomain Domain of objects to be retrieved, if null no domain check performed
   * @param rtrInstIds Instance Identifier of objects to be retrieved
   * @param retrievAll Boolean value if set to all instance identifier check not performed
