...
/**
 * AggregationDynamicDataset implements the dataset #AG-4.
 */
public class AggregationDynamicDataset extends AggregationDataset {
	...
	public AggregationDynamicDataset(BackendTimer timer, SingleConnectionDetails parameterConnectionDetails) {
