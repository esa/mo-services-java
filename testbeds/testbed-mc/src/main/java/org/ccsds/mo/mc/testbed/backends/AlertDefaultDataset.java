...
/**
 * AlertDefaultDataset implements the dataset #AL-2.
 */
public class AlertDefaultDataset extends AlertDataset {
	...
	public static final ObjectRef<AlertDefinition> sat1Mtq1VoltageLowRef =
			new ObjectRef<>(
					Constant.DOMAIN_SAT1,
					AlertDefinition.TYPE_ID.getTypeId(),
					Constant.ID_MTQ1VOLTAGE_LOW,
					new UInteger(1));
	public final int sat1Mtq1VoltageLowAdId;

	public AlertDefaultDataset() {
