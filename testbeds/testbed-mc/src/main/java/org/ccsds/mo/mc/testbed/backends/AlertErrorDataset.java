...
/**
 * AlertErrorDataset implements the dataset #AL-9.
 */
public class AlertErrorDataset extends AlertDataset {
	...
	public static final ObjectRef<AlertDefinition> sat2Mtq1VoltageHighRef =
			new ObjectRef<>(
					Constant.DOMAIN_SAT2,
					AlertDefinition.TYPE_ID.getTypeId(),
					Constant.ID_MTQ1VOLTAGE_HIGH,
					new UInteger(1));
	public final int sat2Mtq1VoltageHighAdId;

	public AlertErrorDataset() {
		...
		// AlertDefinition
		// - identity: ("fr.cnes.mission.sat2", "MTQ1VOLTAGE_HIGH", version=1)
		// - description: ""
		// - severity: SEVERE
		// - arguments: { "MTQ1VOLTAGE_HIGH_VAL" }
		sat2Mtq1VoltageHighAdId =
				addAlert(
						new ObjectIdentity(
								Constant.DOMAIN_SAT2,
								Constant.ID_MTQ1VOLTAGE_HIGH,
