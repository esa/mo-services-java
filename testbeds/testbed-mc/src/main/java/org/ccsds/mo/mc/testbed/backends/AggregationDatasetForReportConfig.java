...
/**
 * AggregationDatasetForReportConfig implements the dataset #AG-3.
 */
public class AggregationDatasetForReportConfig extends AggregationDataset {
	...
	public AggregationDatasetForReportConfig(BackendTimer timer, SingleConnectionDetails parameterConnectionDetails) {
