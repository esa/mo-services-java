 ...
 * the source Plan, the criteria used to select the partial plan, and the
 * partial plan itself.  The partial plan uses the same structure as a normal
 * Plan, with header fields matching those of the source Plan, but only containing
 * the subset of ActivityInstances that matches the selection criteria.  Whether
 * EventInstances and Resources are included is implementation specific, but
...
public final class PartialPlan implements org.ccsds.moims.mo.mal.structures.Composite {
     ...
     */
    public static final Long SHORT_FORM = 1407374900331011L;
    /**
     ...
     * @param partialPlanStart Selection criterion indicating the start of a range of time, position, or events associated with contained ActivityInstances.
    ...
    public boolean equals(Object obj) {
        if (obj instanceof PartialPlan) {
            ...
            if (partialPlan == null) {
                if (other.partialPlan != null) {
                    return false;
                }
            } else {
                if (! partialPlan.equals(other.partialPlan)) {
                    return false;
                }
            }
            return true;
    ...
    public int hashCode() {
        ...
        hash = 83 * hash + (partialPlan != null ? partialPlan.hashCode() : 0);
        return hash;
    }
    ...
    public String toString() {
        ...
        buf.append(", partialPlan=").append(partialPlan);
        buf.append(')');
        return buf.toString();
    }
