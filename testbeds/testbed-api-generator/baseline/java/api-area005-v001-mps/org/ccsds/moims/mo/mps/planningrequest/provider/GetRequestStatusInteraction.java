...
/**
 * Provider PROGRESS interaction class for PlanningRequest::getRequestStatus
 * operation.
 */
public class GetRequestStatusInteraction {
     ...
     */
    public GetRequestStatusInteraction(org.ccsds.moims.mo.mal.provider.MALProgress interaction) {
     ...
     * @throws org.ccsds.moims.mo.mal.MALException if there is an implementation exception
     */
    public org.ccsds.moims.mo.mal.transport.MALMessage sendUpdate(org.ccsds.moims.mo.mps.structures.RequestStatusUpdateList requestStatuses) throws org.ccsds.moims.mo.mal.MALInteractionException, org.ccsds.moims.mo.mal.MALException {
        return interaction.sendUpdate(requestStatuses);
    }
