...
/**
 * Typed accessors for the Subscription Keys of the monitorSubPlanExecution
 * PubSub operation.
 */
public final class MonitorSubPlanExecutionSubscriptionKeys {
     ...
     */
    private static final org.ccsds.moims.mo.mal.structures.IdentifierList CANONICAL_KEY_NAMES = new org.ccsds.moims.mo.mal.structures.IdentifierList(new java.util.ArrayList<>(java.util.Arrays.asList(new org.ccsds.moims.mo.mal.structures.Identifier("subPlan"))));
     ...
     */
    public MonitorSubPlanExecutionSubscriptionKeys(org.ccsds.moims.mo.mal.structures.UpdateHeader updateHeader,
