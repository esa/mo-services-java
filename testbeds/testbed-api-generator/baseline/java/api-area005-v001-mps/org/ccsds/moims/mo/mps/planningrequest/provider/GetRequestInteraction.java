...
/**
 * Provider PROGRESS interaction class for PlanningRequest::getRequest operation.
 */
public class GetRequestInteraction {
     ...
     */
    public GetRequestInteraction(org.ccsds.moims.mo.mal.provider.MALProgress interaction) {
     ...
     * @throws org.ccsds.moims.mo.mal.MALException if there is an implementation exception
     */
    public org.ccsds.moims.mo.mal.transport.MALMessage sendUpdate(org.ccsds.moims.mo.mps.structures.RequestInstanceList requestInstances) throws org.ccsds.moims.mo.mal.MALInteractionException, org.ccsds.moims.mo.mal.MALException {
        return interaction.sendUpdate(requestInstances);
    }
