...
/**
 * Publisher class for the monitorPlan operation.
 */
public final class MonitorPlanPublisher {
     ...
     */
    public MonitorPlanPublisher(org.ccsds.moims.mo.mal.provider.MALPublisherSet publisherSet) {
    ...
    public void publish(org.ccsds.moims.mo.mal.structures.UpdateHeader updateHeader,
            org.ccsds.moims.mo.mps.structures.Plan plan) throws java.lang.IllegalArgumentException, org.ccsds.moims.mo.mal.MALInteractionException, org.ccsds.moims.mo.mal.MALException {
        publisherSet.publish(updateHeader, plan);
    }
