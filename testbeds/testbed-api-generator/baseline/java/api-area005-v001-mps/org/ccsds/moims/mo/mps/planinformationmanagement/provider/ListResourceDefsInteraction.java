...
/**
 * Provider PROGRESS interaction class for PlanInformationManagement::listResourceDefs
 * operation.
 */
public class ListResourceDefsInteraction {
     ...
     */
    public ListResourceDefsInteraction(org.ccsds.moims.mo.mal.provider.MALProgress interaction) {
     ...
     * @throws org.ccsds.moims.mo.mal.MALException if there is an implementation exception
     */
    public org.ccsds.moims.mo.mal.transport.MALMessage sendUpdate(org.ccsds.moims.mo.mps.structures.DefListEntryList resourceDefs) throws org.ccsds.moims.mo.mal.MALInteractionException, org.ccsds.moims.mo.mal.MALException {
        return interaction.sendUpdate(resourceDefs);
    }
