...
/**
 * Publisher class for the monitorSubPlanExecution operation.
 */
public final class MonitorSubPlanExecutionPublisher {
     ...
     */
    public MonitorSubPlanExecutionPublisher(org.ccsds.moims.mo.mal.provider.MALPublisherSet publisherSet) {
    ...
    public void publish(org.ccsds.moims.mo.mal.structures.UpdateHeader updateHeader,
            org.ccsds.moims.mo.mps.structures.SubPlanUpdate subPlanUpdate) throws java.lang.IllegalArgumentException, org.ccsds.moims.mo.mal.MALInteractionException, org.ccsds.moims.mo.mal.MALException {
        publisherSet.publish(updateHeader, subPlanUpdate);
    }
