 ...
 */
public abstract class DirectoryInheritanceSkeleton implements org.ccsds.moims.mo.mal.provider.MALInteractionHandler, org.ccsds.moims.mo.common.directory.provider.DirectorySkeleton, org.ccsds.moims.mo.common.directory.provider.DirectoryHandler {

    /**
     * The providerSet field.
     */
    private org.ccsds.moims.mo.mal.provider.MALProviderSet providerSet = new org.ccsds.moims.mo.mal.provider.MALProviderSet(org.ccsds.moims.mo.common.directory.DirectoryHelper.DIRECTORY_SERVICE);
    ...
    @Override
    public void setSkeleton(org.ccsds.moims.mo.common.directory.provider.DirectorySkeleton skeleton) {
    ...
    public void handleSubmit(org.ccsds.moims.mo.mal.provider.MALSubmit interaction,
        ...
        switch (opNumber) {
          case org.ccsds.moims.mo.common.directory.DirectoryServiceInfo._WITHDRAWPROVIDER_OP_NUMBER:
            withdrawProvider((body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Long.MAX_VALUE)) == null) ? null : ((org.ccsds.moims.mo.mal.structures.Union) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Long.MAX_VALUE))).getLongValue(),
                interaction);
    ...
    public void handleRequest(org.ccsds.moims.mo.mal.provider.MALRequest interaction,
        ...
        switch (opNumber) {
          case org.ccsds.moims.mo.common.directory.DirectoryServiceInfo._LOOKUPPROVIDER_OP_NUMBER:
            interaction.sendResponse(lookupProvider((org.ccsds.moims.mo.common.directory.structures.ServiceFilter) body.getBodyElement(0, new org.ccsds.moims.mo.common.directory.structures.ServiceFilter()),
                interaction));
            break;
          case org.ccsds.moims.mo.common.directory.DirectoryServiceInfo._PUBLISHPROVIDER_OP_NUMBER:
            org.ccsds.moims.mo.common.directory.body.PublishProviderResponse publishProviderRt = publishProvider((org.ccsds.moims.mo.common.directory.structures.PublishDetails) body.getBodyElement(0, new org.ccsds.moims.mo.common.directory.structures.PublishDetails()),
                interaction);
            interaction.sendResponse(
                    (publishProviderRt.getProviderObjId() == null) ? null : new org.ccsds.moims.mo.mal.structures.Union(publishProviderRt.getProviderObjId()),
                    (publishProviderRt.getCapabilitiesObjId() == null) ? null : new org.ccsds.moims.mo.mal.structures.Union(publishProviderRt.getCapabilitiesObjId())
            );
            break;
          case org.ccsds.moims.mo.common.directory.DirectoryServiceInfo._GETSERVICEXML_OP_NUMBER:
            interaction.sendResponse(getServiceXML((body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Long.MAX_VALUE)) == null) ? null : ((org.ccsds.moims.mo.mal.structures.Union) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Long.MAX_VALUE))).getLongValue(),
                interaction));
            break;
          default:
            interaction.sendError(new org.ccsds.moims.mo.mal.UnsupportedOperationException(
