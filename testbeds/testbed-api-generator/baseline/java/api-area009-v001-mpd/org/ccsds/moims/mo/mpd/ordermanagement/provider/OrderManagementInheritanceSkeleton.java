...
/**
 * Provider Inheritance skeleton for OrderManagementInheritanceSkeleton service.
 */
public abstract class OrderManagementInheritanceSkeleton implements org.ccsds.moims.mo.mal.provider.MALInteractionHandler, org.ccsds.moims.mo.mpd.ordermanagement.provider.OrderManagementSkeleton, org.ccsds.moims.mo.mpd.ordermanagement.provider.OrderManagementHandler {

    /**
     * The providerSet field.
     */
    private org.ccsds.moims.mo.mal.provider.MALProviderSet providerSet = new org.ccsds.moims.mo.mal.provider.MALProviderSet(org.ccsds.moims.mo.mpd.ordermanagement.OrderManagementHelper.ORDERMANAGEMENT_SERVICE);
    ...
    @Override
    public void setSkeleton(org.ccsds.moims.mo.mpd.ordermanagement.provider.OrderManagementSkeleton skeleton) {
    ...
    public void handleSubmit(org.ccsds.moims.mo.mal.provider.MALSubmit interaction,
        ...
        switch (opNumber) {
          case org.ccsds.moims.mo.mpd.ordermanagement.OrderManagementServiceInfo._CANCELSTANDINGORDER_OP_NUMBER:
            cancelStandingOrder((body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Long.MAX_VALUE)) == null) ? null : ((org.ccsds.moims.mo.mal.structures.Union) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Union(Long.MAX_VALUE))).getLongValue(),
                interaction);
    ...
    public void handleRequest(org.ccsds.moims.mo.mal.provider.MALRequest interaction,
        ...
        switch (opNumber) {
          case org.ccsds.moims.mo.mpd.ordermanagement.OrderManagementServiceInfo._LISTSTANDINGORDERS_OP_NUMBER:
            interaction.sendResponse(listStandingOrders((org.ccsds.moims.mo.mal.structures.Identifier) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.Identifier()),
          ...
          case org.ccsds.moims.mo.mpd.ordermanagement.OrderManagementServiceInfo._SUBMITSTANDINGORDER_OP_NUMBER:
            Long submitStandingOrderRt = submitStandingOrder((org.ccsds.moims.mo.mpd.structures.StandingOrder) body.getBodyElement(0, new org.ccsds.moims.mo.mpd.structures.StandingOrder()),
                interaction);
            interaction.sendResponse((submitStandingOrderRt == null) ? null : new org.ccsds.moims.mo.mal.structures.Union(submitStandingOrderRt));
            break;
          default:
            interaction.sendError(new org.ccsds.moims.mo.mal.UnsupportedOperationException(
                    org.ccsds.moims.mo.mal.provider.MALInteractionHandler.ERROR_MSG_UNSUPPORTED + opNumber));
