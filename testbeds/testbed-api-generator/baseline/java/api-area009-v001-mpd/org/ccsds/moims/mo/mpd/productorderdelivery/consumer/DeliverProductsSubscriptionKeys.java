...
/**
 * Typed accessors for the Subscription Keys of the deliverProducts PubSub
 * operation.
 */
public final class DeliverProductsSubscriptionKeys {
     ...
     */
    public DeliverProductsSubscriptionKeys(org.ccsds.moims.mo.mal.structures.UpdateHeader updateHeader,
    ...
    /**
     * Returns the value of the "user" Subscription Key, or null if not present.
     * 
    ...
    /**
     * Returns the value of the "orderID" Subscription Key, or null if not present.
     * 
     * @return The key value, or null if not present
     */
