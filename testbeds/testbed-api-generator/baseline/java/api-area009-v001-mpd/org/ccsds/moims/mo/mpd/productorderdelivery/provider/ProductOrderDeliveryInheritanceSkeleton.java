...
/**
 * Provider Inheritance skeleton for ProductOrderDeliveryInheritanceSkeleton
 * service.
 */
public abstract class ProductOrderDeliveryInheritanceSkeleton implements org.ccsds.moims.mo.mal.provider.MALInteractionHandler, org.ccsds.moims.mo.mpd.productorderdelivery.provider.ProductOrderDeliverySkeleton, org.ccsds.moims.mo.mpd.productorderdelivery.provider.ProductOrderDeliveryHandler {

    /**
     * The providerSet field.
     */
    private org.ccsds.moims.mo.mal.provider.MALProviderSet providerSet = new org.ccsds.moims.mo.mal.provider.MALProviderSet(org.ccsds.moims.mo.mpd.productorderdelivery.ProductOrderDeliveryHelper.PRODUCTORDERDELIVERY_SERVICE);
    ...
    @Override
    public void setSkeleton(org.ccsds.moims.mo.mpd.productorderdelivery.provider.ProductOrderDeliverySkeleton skeleton) {
    ...
    @Override
    public org.ccsds.moims.mo.mpd.productorderdelivery.provider.NotifyProductDeliveryPublisher createNotifyProductDeliveryPublisher(org.ccsds.moims.mo.mal.structures.IdentifierList domain,
        ...
        return new org.ccsds.moims.mo.mpd.productorderdelivery.provider.NotifyProductDeliveryPublisher(providerSet.createPublisherSet(org.ccsds.moims.mo.mpd.productorderdelivery.ProductOrderDeliveryServiceInfo.NOTIFYPRODUCTDELIVERY_OP, domain, sessionType, sessionName, qos, qosProps, null));
    }

    @Override
    public org.ccsds.moims.mo.mpd.productorderdelivery.provider.DeliverProductsPublisher createDeliverProductsPublisher(org.ccsds.moims.mo.mal.structures.IdentifierList domain,
            org.ccsds.moims.mo.mal.structures.Identifier networkZone,
            org.ccsds.moims.mo.mal.structures.SessionType sessionType,
            org.ccsds.moims.mo.mal.structures.Identifier sessionName,
            org.ccsds.moims.mo.mal.structures.QoSLevel qos,
            java.util.Map qosProps,
            org.ccsds.moims.mo.mal.structures.UInteger priority) throws org.ccsds.moims.mo.mal.MALException {
        return new org.ccsds.moims.mo.mpd.productorderdelivery.provider.DeliverProductsPublisher(providerSet.createPublisherSet(org.ccsds.moims.mo.mpd.productorderdelivery.ProductOrderDeliveryServiceInfo.DELIVERPRODUCTS_OP, domain, sessionType, sessionName, qos, qosProps, null));
    }
