...
public final class MonitorValueSubscriptionKeys {
    ...
    /**
     * Returns the value of the "aggregationKey" Subscription Key, or null if
     * not present.
     * 
     * @return The key value, or null if not present
     */
    public org.ccsds.moims.mo.mal.structures.Identifier getAggregationKey() {
        return (org.ccsds.moims.mo.mal.structures.Identifier) valueByName("aggregationKey");
    }

    /**
     * Returns the value of the "aggregationVersion" Subscription Key, or null
     * if not present.
     * 
     * @return The key value, or null if not present
     */
    public org.ccsds.moims.mo.mal.structures.UInteger getAggregationVersion() {
        return (org.ccsds.moims.mo.mal.structures.UInteger) valueByName("aggregationVersion");
    }
