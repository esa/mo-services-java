...
/**
 * Typed accessors for the Subscription Keys of the deliverPacket PubSub operation.
 */
public final class DeliverPacketSubscriptionKeys {
     ...
     */
    private static final org.ccsds.moims.mo.mal.structures.IdentifierList CANONICAL_KEY_NAMES = new org.ccsds.moims.mo.mal.structures.IdentifierList(new java.util.ArrayList<>(java.util.Arrays.asList(new org.ccsds.moims.mo.mal.structures.Identifier("apid"))));
     ...
     */
    public DeliverPacketSubscriptionKeys(org.ccsds.moims.mo.mal.structures.UpdateHeader updateHeader,
    ...
    /**
     * Returns the value of the "apid" Subscription Key, or null if not present.
     * 
     * @return The key value, or null if not present
     */
    public org.ccsds.moims.mo.mal.structures.UShort getApid() {
        return (org.ccsds.moims.mo.mal.structures.UShort) valueByName("apid");
    }
