    ...
    public void handleSubmit(org.ccsds.moims.mo.mal.provider.MALSubmit interaction,
        ...
        switch (opNumber) {
          ...
          case org.ccsds.moims.mo.mc.aggregation.AggregationServiceInfo._ADDAGGREGATION_OP_NUMBER:
            addAggregation((org.ccsds.moims.mo.mc.structures.AggregationDefinitionList) body.getBodyElement(0, new org.ccsds.moims.mo.mc.structures.AggregationDefinitionList()),
                interaction);
            interaction.sendAcknowledgement();
            break;
          case org.ccsds.moims.mo.mc.aggregation.AggregationServiceInfo._REMOVEAGGREGATION_OP_NUMBER:
            removeAggregation((org.ccsds.moims.mo.mal.structures.IdentifierList) body.getBodyElement(0, new org.ccsds.moims.mo.mal.structures.IdentifierList()),
                (org.ccsds.moims.mo.mal.structures.IdentifierList) body.getBodyElement(1, new org.ccsds.moims.mo.mal.structures.IdentifierList()),
                interaction);
            interaction.sendAcknowledgement();
            break;
