 ...
 */
public abstract class PacketInheritanceSkeleton implements org.ccsds.moims.mo.mal.provider.MALInteractionHandler, org.ccsds.moims.mo.mc.packet.provider.PacketSkeleton, org.ccsds.moims.mo.mc.packet.provider.PacketHandler {

    /**
     * The providerSet field.
     */
    private org.ccsds.moims.mo.mal.provider.MALProviderSet providerSet = new org.ccsds.moims.mo.mal.provider.MALProviderSet(org.ccsds.moims.mo.mc.packet.PacketHelper.PACKET_SERVICE);
    ...
    @Override
    public void setSkeleton(org.ccsds.moims.mo.mc.packet.provider.PacketSkeleton skeleton) {
    ...
    @Override
    public org.ccsds.moims.mo.mc.packet.provider.DeliverPacketPublisher createDeliverPacketPublisher(org.ccsds.moims.mo.mal.structures.IdentifierList domain,
        ...
        return new org.ccsds.moims.mo.mc.packet.provider.DeliverPacketPublisher(providerSet.createPublisherSet(org.ccsds.moims.mo.mc.packet.PacketServiceInfo.DELIVERPACKET_OP, domain, sessionType, sessionName, qos, qosProps, null));
    }
