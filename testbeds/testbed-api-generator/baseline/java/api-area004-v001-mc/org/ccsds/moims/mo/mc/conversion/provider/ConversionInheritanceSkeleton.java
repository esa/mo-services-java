...
/**
 * Provider Inheritance skeleton for ConversionInheritanceSkeleton service.
 */
public abstract class ConversionInheritanceSkeleton implements org.ccsds.moims.mo.mal.provider.MALInteractionHandler, org.ccsds.moims.mo.mc.conversion.provider.ConversionSkeleton, org.ccsds.moims.mo.mc.conversion.provider.ConversionHandler {

    /**
     * The providerSet field.
     */
    private org.ccsds.moims.mo.mal.provider.MALProviderSet providerSet = new org.ccsds.moims.mo.mal.provider.MALProviderSet(org.ccsds.moims.mo.mc.conversion.ConversionHelper.CONVERSION_SERVICE);
    ...
    @Override
    public void setSkeleton(org.ccsds.moims.mo.mc.conversion.provider.ConversionSkeleton skeleton) {
