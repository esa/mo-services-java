...
/**
 * Provider Inheritance skeleton for GroupInheritanceSkeleton service.
 */
public abstract class GroupInheritanceSkeleton implements org.ccsds.moims.mo.mal.provider.MALInteractionHandler, org.ccsds.moims.mo.mc.group.provider.GroupSkeleton, org.ccsds.moims.mo.mc.group.provider.GroupHandler {

    /**
     * The providerSet field.
     */
    private org.ccsds.moims.mo.mal.provider.MALProviderSet providerSet = new org.ccsds.moims.mo.mal.provider.MALProviderSet(org.ccsds.moims.mo.mc.group.GroupHelper.GROUP_SERVICE);
    ...
    @Override
    public void setSkeleton(org.ccsds.moims.mo.mc.group.provider.GroupSkeleton skeleton) {
