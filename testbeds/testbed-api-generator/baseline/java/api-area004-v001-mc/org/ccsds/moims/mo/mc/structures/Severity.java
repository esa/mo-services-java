...
public final class Severity extends org.ccsds.moims.mo.mal.structures.Enumeration {
     ...
     */
    public static final Long SHORT_FORM = 1125899923619846L;
    /**
    ...
    /**
     * The severity enumeration holds the possible values for a severity. The
     * numerical value represents the increasing severity, therefore CRITICAL
     * is more severe than ALARM. Normally, for checks, only the Warning and Critical
     * ranges are used: the colour yellow is associated with Warning, and the
     * colour red is associated with Critical.
     * 
