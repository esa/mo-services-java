...
public class Main
{
  public static void main(String[] args) throws Exception
  {
    if (2 <= args.length)
    {
      ...
      System.out.println("Starting bridge between transport " + protocolA + " and " + protocolB);
      loadProperties();
  ...
  private static void wrapURIs(String srcFilename, String outputfileName, URI uri) throws Exception
  {
    ...
    if (file.exists())
    {
      ...
      storeURIs(outputfileName, uri.getValue() + "@" + props.getProperty("uri"), uri.getValue() + "@" + props.getProperty("broker"));
    }
  }
