...
/**
 * This class is the archive provider. It provides the archive functionality specified in the COM specification. It acts
 * as the interface front end using the Archive class to store & retrieve events
 */
public class ArchiveHandlerImpl extends ArchiveInheritanceSkeleton
{
  ...
  /**
   * For a list instance identifiers checks they all exist in a list of archive objects
   *
   * @param instIds
  ...
  /**
   * Object types can be defined with no body. This function checks if a specified ObjectType corresponds to one which
   * is defined in XML spec as having no body. Note this function only supports ObjectTypes used in the test
   *
   * @param objectType
   * @return result
   */
  ...
  /**
   * Checks if a domain matches a domain specified in a query. The check takes into account wildcards in the query.
   *
  ...
  /**
   * Checks if an objectId match the value specified in a query. The check takes into account wildcards in the query.
   *
  ...
  /**
   * Checks if a filter operator is contains or icontains and if so checks if the specified value is a string
   *
   * @param compositeFilter check the contains rule - contains/icontains only valid for string
  ...
  /**
   * Apply a composite set filter to a list of objects. Filter applied ANDing the individual filters.
   *
   * @param objs
  ...
  /**
   * Applies query to a list of archive objects, returning a list of objects which pass the query
   *
  ...
  /**
   * Apply a sort to a number of object lists, where each list holds entries for an Object Type/domain pair. This means
   * all entries will have the same type
   *
  ...
  /**
   * Creates a ArchiveObjectList for each domain/ObectType combination in an an input list
   *
  ...
  /**
   * Generates and sends the query results using update and response methods on the interaction
   *
   * @param bodyRequired - specifies whether the object body should be required
  ...
  /**
   * Performs a query on the archive the results are returned via the interaction. Multiple results can be returned
   * using the Update call. A result shall be generated for each ObjectType found.
   *
   ...
   * @param queryFilterList general purpose filters to be applied (can be NULL)
   ...
   *
   * @param objectType ObjectType of objects to be counted can contain wildcards
  ...
  /**
   * Checks if any of the instance identifiers in the archive details list are duplicates
   *
   * @param archiveDetailsList
  ...
  /**
   * Checks validity of set of parameters supplied as part of a store operation
   *
   * @param setInstId
   * @param objectType
   * @param domain
   ...
   *
   * @param setInstId - specifies whether instance identifier should be allocated within operation
   ...
   * @param objectType objectType to match for deletion
   * @param domain domain to match for deletion
   * @param instIds instance identifiers to be matched for deletion (can wildcard)
   * @param interaction
