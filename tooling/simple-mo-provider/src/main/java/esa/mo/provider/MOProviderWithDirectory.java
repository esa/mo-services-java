 ...
 * few other services.
 */
public class MOProviderWithDirectory {
    ...
    public void init() {
        ...
        try {
            Logger.getLogger(MOProviderWithDirectory.class.getName()).log(Level.INFO,
            ...
            Logger.getLogger(MOProviderWithDirectory.class.getName()).log(Level.SEVERE,
        ...
        Logger.getLogger(MOProviderWithDirectory.class.getName()).log(
