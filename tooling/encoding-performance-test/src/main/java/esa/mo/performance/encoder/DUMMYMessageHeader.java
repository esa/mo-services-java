...
public class DUMMYMessageHeader implements MALMessageHeader, Element {
    ...
    public DUMMYMessageHeader(URI uriFrom, Blob authenticationId, URI uriTo,
            ...
            UShort service, UShort operation, UOctet areaVersion, Boolean isErrorMessage) {
    ...
    public String toString() {
        return "GENMessageHeader{"
                + "URIFrom=" + URIFrom
                + ", authenticationId=" + authenticationId + ", URITo=" + URITo
                + ", timestamp=" + timestamp + ", QoSlevel=" + QoSlevel
                ...
                + ", operation=" + operation + ", serviceVersion=" + areaVersion
