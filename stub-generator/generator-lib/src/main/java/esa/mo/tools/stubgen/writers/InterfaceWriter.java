...
/**
 * Writer used when creating an interface style class (such as a C++ pure
 * virtual base class).
 */
public interface InterfaceWriter extends LanguageWriter {
     ...
     * @param extendsInterface Which other interfaces does this interface
     * extend.
     * @param comment Comment for the interface.
     * @throws IOException If there is an IO error.
     */
    void addInterfaceOpenStatement(String interfaceName, 
