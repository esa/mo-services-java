 ...
 */
public class VariableBinaryListDecoder extends VariableBinaryDecoder implements org.ccsds.moims.mo.mal.MALListDecoder
{
   ...
   */
  public VariableBinaryListDecoder(final java.util.List list, final BufferHolder srcBuffer)
