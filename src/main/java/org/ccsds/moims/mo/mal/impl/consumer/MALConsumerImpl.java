...
public class MALConsumerImpl extends MALClose implements MALConsumer
{
  ...
  {
    sender.synchronousInteraction(details, op, MALSubmitOperation.SUBMIT_STAGE, (MALInteractionListener) null, requestBody);
  }

  @Override
  public Element request(MALRequestOperation op, Element requestBody) throws MALException
  {
    return sender.synchronousInteraction(details, op, MALRequestOperation.REQUEST_STAGE, (MALInteractionListener) null, requestBody);
  }
