...
/**
 * The MALEndpoint interface sends and receive MALMessages. A new MALEndpoint is created when the MAL layer needs to
 * allocate a new URI. This happens when creating a MALConsumer, MALProvider, or a MALBrokerBinding owned by a
 * MALBroker. In those cases, the URI of the MALConsumer, the MALProvider, or the MALBrokerBinding is the one owned by
 * its MALEndpoint. A MALEndpoint is a MALMessage factory.
 *
 */
public interface MALEndpoint
{
   ...
   * @throws java.lang.IllegalArgumentException If any of the parameters except ‘transactionId’ or ‘qosProperties’ are
   * NULL
   * @throws MALException If the MALEndpoint is closed
   */
   ...
   * @throws MALException If the MALEndpoint is closed
   */
  void sendMessage(MALMessage msg) throws java.lang.IllegalArgumentException, MALTransmitErrorException, MALException;

  /**
   * The method sends a list of MALMessages. Throws MALTransmitMultipleErrorException If a MULTIPLETRANSMIT ERROR occurs
   *
