...
public class MALPubSubOperation extends MALOperation
{
   ...
   * @param updateListShortForms Absolute short forms of the update lists transmitted by the PUBLISH/NOTIFY message of a
   * PUBLISH-SUBSCRIBE operation.
   * @param lastUpdateListShortForms Absolute short forms of the update lists that can be assigned to the last element
   * of the PUBLISH/NOTIFY message body
  ...
  public MALPubSubOperation(final UShort number,
          ...
          final Object[] lastUpdateListShortForms) throws java.lang.IllegalArgumentException
  {
