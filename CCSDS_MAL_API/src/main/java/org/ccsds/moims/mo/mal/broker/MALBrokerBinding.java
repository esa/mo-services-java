...
/**
 * The MALBrokerBinding interface represents: a binding of a shared MAL level broker to a transport layer; a transport
 * level broker.
 *
 */
public interface MALBrokerBinding
{
   ...
   * @throws java.lang.IllegalArgumentException If at least one of the arguments, except ‘notifyQoSProps’, is NULL
   * @throws MALInteractionException if a MAL standard error occurs during the message sending
   * @throws MALException thrown if a non-MAL error occurs during the message sending, MALBrokerBinding represents a
   * transport level broker or is linked to a MAL level broker without MALBrokerHandler, or MALBrokerBinding is closed.
   */
  ...
  /**
   * The method enables a MALBrokerHandler to send a NOTIFY ERROR message to a subscriber
   *
  ...
  /**
   * The method enables a MALBrokerHandler to send a PUBLISH ERROR message to a publisher
   *
  ...
  /**
   * The method terminates all pending interactions and deactivates the broker binding.
   *
