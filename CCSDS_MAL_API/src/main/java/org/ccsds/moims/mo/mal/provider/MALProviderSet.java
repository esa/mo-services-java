...
/**
 * The MALProviderSet class manages a list of MALProvider providing the same service through different protocols and
 * create instances of MALPublisherSet, register their references and update them when a MALProvider is either added or
 * removed.
 *
 */
public class MALProviderSet
{
   ...
   *
   * @param service The service to be provided by the MALProviders added in this MALProviderSet
   * @throws java.lang.IllegalArgumentException If the parameter ‘service’ is NULL
   */
  public MALProviderSet(final MALService service)
   ...
   * @throws java.lang.IllegalArgumentException If the parameters ‘op’ or ‘domain’ or ‘networkZone’ or ‘sessionType’ or
   * ‘sessionName’ or ‘remotePublisherQos’ or ‘remotePublisherPriority’ are NULL
   ...
   * @throws java.lang.IllegalArgumentException If the parameter ‘provider’ is NULL
   * @throws MALException If the added MALProvider provides a MALService which is not the same as the MALService of this
   * MALProviderSet
   */
   ...
   * @return If this MALProviderSet contains the specified provider then the method returns ‘true’ otherwise it returns
   * ‘false’.
   * @throws java.lang.IllegalArgumentException If the parameter ‘provider’ is NULL
   */
  public boolean removeProvider(final MALProvider provider)
          throws java.lang.IllegalArgumentException
  {
