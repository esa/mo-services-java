...
/**
 * The Union class assigns a MAL Attribute mapped to a non-Element Java type (e.g. Boolean, String) to an Element
 * variable.
 */
public class Union implements Attribute
{
   ...
   * @throws java.lang.IllegalArgumentException If the parameter ‘value’ is NULL.
   */
