...
/**
 * The MALTransportFactory class enables the MAL layer to instantiate and configure a MALTransport.
 */
public abstract class MALTransportFactory
{
  ...
  /**
   * The method allows an implementation to register the class of a specific MALTransportFactory. NOTE – This method may
   * be useful in environments where several class loaders are involved (e.g., OSGi platforms).
   *
   * @param factoryClass Class extending MALTransportFactory
   * @throws IllegalArgumentException if the argument does not extend MALTransportFactory
   */
  ...
  /**
   * The method allows an implementation to deregister the class of a specific MALTransportFactory.
   *
   ...
   *
   * @param protocol Name of the protocol to be handled by the instantiated MALTransportFactory
   * @return The instance.
   ...
   */
  public static MALTransportFactory newFactory(final String protocol) throws IllegalArgumentException, MALException
  {
    ...
    {
      throw new MALException("Unknown transport factory for protocol: " + protocol);
    }
  }
   ...
   */
  public abstract MALTransport createTransport(MALContext malContext, java.util.Map properties) throws MALException;
}
