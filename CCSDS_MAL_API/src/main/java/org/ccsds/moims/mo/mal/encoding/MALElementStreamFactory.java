...
public abstract class MALElementStreamFactory
{
   ...
   * @throws IllegalArgumentException if the argument does not extend MALElementStreamFactory
   */
  ...
  /**
   * The method allows an implementation to deregister the class of a specific MALElementStreamFactory.
   *
   ...
   *
   * @param protocol Name of the protocol to be handled by the instantiated MALElementStreamFactory
   * @param qosProperties Configuration properties
   * @return The new factory.
   * @throws MALException If an error detected during instantiation.
   */
  public static MALElementStreamFactory newFactory(final String protocol, final Map qosProperties) throws MALException
  {
   ...
   * @throws java.lang.IllegalArgumentException If the protocol string is null.
