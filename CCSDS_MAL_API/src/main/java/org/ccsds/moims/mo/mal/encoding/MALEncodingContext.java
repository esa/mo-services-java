...
/**
 * The class MALEncodingContext gives access to: the header of the MALMessage that contains the Element to encode or
 * decode; the description of the operation that has been called; the index of the body element to encode or decode; the
 * list of the QoS properties owned by the MALEndpoint that sends or receives the Element; the list of the QoS
 * properties owned by the MALMessage that contains the Element to encode or decode.
 *
 */
public class MALEncodingContext
{
   ...
   * @param endpointQosProperties the QoS properties owned by the MALEndpoint that sends or receives the Element
   * @param messageQosProperties the QoS properties owned by the MALMessage that contains the Element to encode or
   * decode
   */
