...
/**
 * This thread is responsible for receiving data from a connection that was initiated by this MAL (Client connection).
 * Its main difference than its parent, which is normaly used in reading data from server connections, is that at
 * construction time we know the remote URI associated with this resource. Thus the transport will not re-associate this
 * resource with a URI on the first reception message.
 *
 */
