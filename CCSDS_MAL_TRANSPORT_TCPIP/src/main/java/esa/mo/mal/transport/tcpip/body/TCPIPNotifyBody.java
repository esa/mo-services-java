 ...
 */
public class TCPIPNotifyBody extends TCPIPPublishBody implements MALNotifyBody {
     ...
     */
    public TCPIPNotifyBody(final MALEncodingContext ctx, final Object[] messageParts) {
     ...
     *            parts.
     */
    public TCPIPNotifyBody(final MALEncodingContext ctx, final boolean wrappedBodyParts, final MALElementStreamFactory encFactory, final MALElementInputStream encBodyElements) {
