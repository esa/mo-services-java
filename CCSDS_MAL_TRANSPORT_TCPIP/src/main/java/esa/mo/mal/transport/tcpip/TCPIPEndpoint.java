...
public class TCPIPEndpoint implements MALEndpoint
{
  ...
  public void receiveMessage(final MALMessage pmsg) throws MALException
  {
    ...
    {
      TCPIPTransport.LOGGER.log(Level.WARNING, "GENEndpoint ({0}) Discarding message active({1}) listener({2}) {3}", new Object[]
      {
  ...
  public void receiveMessages(final GENMessage[] pmsgs) throws MALException
  {
    ...
    {
      TCPIPTransport.LOGGER.log(Level.WARNING, "GENEndpoint ({0}) Discarding messages active({1}) listener({2})", new Object[]
      {
