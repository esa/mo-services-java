...
/**
 * TCPIP Transport binding MAL endpoint implementation. Creates messages and generates the correct
 * message header.
 *
...
public class TCPIPEndpoint extends GENEndpoint
{
   ...
   * parameters will be explicitly set in the header, so that they include only the routing part of
   * their respective urls. The routing part is the part of an URL that comes after the service
   * delimiter: maltcp://host:port/routingpart
   */
  @Override
