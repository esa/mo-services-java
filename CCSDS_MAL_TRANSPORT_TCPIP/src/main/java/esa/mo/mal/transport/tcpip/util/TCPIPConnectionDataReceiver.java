...
/**
 * This thread handles a new connection from a client. It receives data from it (MAL packets) and then forwards the
 * incoming packet to an asynchronous processor in order to return immediately and not hold the calling thread while the
 * packet is processed.
 *
