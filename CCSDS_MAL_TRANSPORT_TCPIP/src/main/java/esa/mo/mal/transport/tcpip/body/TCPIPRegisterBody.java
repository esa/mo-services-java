 ...
 */
public class TCPIPRegisterBody extends TCPIPMessageBody implements MALRegisterBody {
     ...
     */
    public TCPIPRegisterBody(final MALEncodingContext ctx, final Object[] messageParts) {
     ...
     *            parts.
     */
    public TCPIPRegisterBody(final MALEncodingContext ctx, final boolean wrappedBodyParts, final MALElementStreamFactory encFactory, final MALElementInputStream encBodyElements) {
