 ...
 */
public class TCPIPPublishRegisterBody extends TCPIPMessageBody implements MALPublishRegisterBody {
     ...
     */
    public TCPIPPublishRegisterBody(final MALEncodingContext ctx, final Object[] messageParts) {
     ...
     *            parts.
     */
    public TCPIPPublishRegisterBody(final MALEncodingContext ctx, final boolean wrappedBodyParts, final MALElementStreamFactory encFactory, final MALElementInputStream encBodyElements) {
