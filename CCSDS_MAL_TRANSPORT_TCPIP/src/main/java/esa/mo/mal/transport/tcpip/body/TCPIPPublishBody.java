 ...
 */
public class TCPIPPublishBody extends TCPIPMessageBody implements MALPublishBody {
     ...
     */
    public TCPIPPublishBody(final MALEncodingContext ctx, final Object[] messageParts) {
     ...
     */
    public TCPIPPublishBody(final MALEncodingContext ctx, final Object[] messageParts, final int offset) {
	super(ctx, messageParts);
	this.offset = offset;
    }
     ...
     *            parts.
     */
    public TCPIPPublishBody(final MALEncodingContext ctx, final boolean wrappedBodyParts, final MALElementStreamFactory encFactory, final MALElementInputStream encBodyElements) {
     ...
     * @param offset The offset in the message parts where the updates start.
     */
    public TCPIPPublishBody(final MALEncodingContext ctx, final boolean wrappedBodyParts, final MALElementStreamFactory encFactory, final MALElementInputStream encBodyElements, final int offset) {
	super(ctx, wrappedBodyParts, encFactory, encBodyElements);
	this.offset = offset;
    }
