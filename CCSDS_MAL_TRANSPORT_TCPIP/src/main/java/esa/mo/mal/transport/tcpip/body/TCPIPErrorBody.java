 ...
 */
public class TCPIPErrorBody extends TCPIPMessageBody implements MALErrorBody {
     ...
     */
    public TCPIPErrorBody(final MALEncodingContext ctx, final Object[] messageParts) {
     ...
     *            parts.
     */
    public TCPIPErrorBody(final MALEncodingContext ctx, final boolean wrappedBodyParts, final MALElementStreamFactory encFactory, final MALElementInputStream encBodyElements) {
