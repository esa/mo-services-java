...
/**
 * Small class that holds the mapping and QoS configuration properties for
...
public class ZMTPConfiguration {
    ...
    private String getStringProperty(final Map properties,
            final String propertyName, String existingValue) {
        if ((null != properties) && properties.containsKey(propertyName)) {
    ...
    private boolean getBooleanProperty(final Map properties,
            final String propertyName, boolean existingValue) {
        if ((null != properties) && properties.containsKey(propertyName)) {
