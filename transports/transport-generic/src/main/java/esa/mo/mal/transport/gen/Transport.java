...
public abstract class Transport<I, O> implements MALTransport {
     ...
     */
    private final OutgoingDataChannels outgoingDataChannelsManager;
    /**
    ...
    public void close() throws MALException {
        ...
        synchronized (this) {
            outgoingDataChannelsManager.closeAll();
        }
    }
    ...
    public synchronized ConcurrentMessageSender manageCommunicationChannel(GENMessage msg,
        ...
        if (isIncomingMsg) {
            ...
            if ((receptionHandler != null) && (receptionHandler.getRemoteURI() == null)) {
                ...
                sender = outgoingDataChannelsManager.registerMessageSender(receptionHandler.getMessageSender(), sourceRootURI);
            }
        } else {
            // outgoing message
            // get target URI
