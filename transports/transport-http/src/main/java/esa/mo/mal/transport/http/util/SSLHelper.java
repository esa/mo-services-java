...
public class SSLHelper {
    ...
    /**
     * Factory method for the creation of the SSLContext according to the
     * supplied Java KeyStore.
     *
     ...
     * @throws HttpApiImplException in case an error occurs when creating the
     * context
     */
    public static SSLContext createSSLContext(String keystoreFilename, String keystorePassword)
