...
/**
 * This interface represents the relevant high-level behaviour a HTTP POST
 * client offers.
 *
 * Actual implementations shall hide any low-level details and simply supply the
 * functionality specified by the required methods.
 */
public interface IPostClient {
    ...
    /**
     * Initialises the actual HTTP client which will connect to the specified
     * remoteUrl.
     *
     ...
     * @throws HttpApiImplException in case an error occurs when initialising or
     ...
     * @throws HttpApiImplException in case an error occurs when writing the
     * request body
     */
    public void writeFullRequestBody(byte[] data) throws HttpApiImplException;

    /**
     * Performs all required operations needed to send the HTTP request, e.g.
     * flush buffers, executing request builders.
     *
     * @throws HttpApiImplException in case an error occurs when sending the
     * request
     */
    public void sendRequest() throws HttpApiImplException;

    /**
     * Gets the HTTP status-code for the response message, e.g. "200 OK", "202
     ...
     *
     * @throws HttpApiImplException in case an error occurs when shutting down
     * the client
     */
