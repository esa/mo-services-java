...
public interface IHttpResponse {
    ...
    /**
     * Sets the HTTP status-code for the response message, e.g. "200 OK", "202
    ...
    /**
     * Performs all required operations needed to commit the HTTP response, e.g.
     * flush buffers, resume suspended resources.
     *
     * See notice at AbstractContextHandler's processResponse() method.
     *
     * @throws HttpApiImplException in case an error occurs when committing the
     * response
     */
