...
public class HelperMisc {
    ...
    public static Element elementList2element(ElementList obj) throws Exception {
        ...
        if (eleFact == null) {
            Logger.getLogger(HelperMisc.class.getName()).log(Level.SEVERE,
                    "The element could not be found in the MAL ElementFactory! The object "
                    + "type is: ''{0}''. Maybe the service Helper for this object "
                    + "was not initialized. Try initializing the Service Helper of this object.",
                    obj.getClass().getSimpleName());
        }
