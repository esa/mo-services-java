...
/**
 * The MALPublisher interface enables a provider to publish updates and errors to registered consumers.
 */
public interface MALPublisher
{
   ...
   * @throws java.lang.IllegalArgumentException If the parameter ‘updateHeaderList’ is NULL.
   ...
   * @throws java.lang.IllegalArgumentException If the parameters ‘entityKeyList’ or ‘listener’ are NULL
   * @throws MALException if a non-MAL error occurs during the initiation message sending or the MALPublisher is closed.
   * @throws MALInteractionException if a PUBLISH REGISTER ERROR or other MAL error occurs.
   */
  void register(EntityKeyList entityKeyList, MALPublishInteractionListener listener)
          throws java.lang.IllegalArgumentException, MALInteractionException, MALException;

  /**
   * The method enables a provider to synchronously deregister from its broker.
   *
   * @throws MALInteractionException if a MAL standard error occurs during the initiation message sending.
   ...
   * PUBLISH ERROR
   * @return the MALMessage that has been sent
   * @throws java.lang.IllegalArgumentException If the parameter ‘entityKeyList’ or ‘listener’ are NULL
   * @throws MALException if a non-MAL error occurs during the initiation message sending or the MALPublisher is closed.
   * @throws MALInteractionException if a MAL error occurs.
   */
  MALMessage asyncRegister(EntityKeyList entityKeyList, MALPublishInteractionListener listener)
          throws java.lang.IllegalArgumentException, MALInteractionException, MALException;

  /**
   * The method enables a provider to asynchronously deregister from its broker.
   *
   * @param listener Listener in charge of receiving the messages PUBLISH DEREGISTER ACK
   * @return the MALMessage that has been sent
   * @throws java.lang.IllegalArgumentException If the parameter ‘listener’ is NULL
   * @throws MALException if a non-MAL error occurs during the initiation message sending or the MALPublisher is closed.
   * @throws MALInteractionException if a MAL error occurs.
   */
