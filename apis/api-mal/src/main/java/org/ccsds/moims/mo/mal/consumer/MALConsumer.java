...
/**
 * The MALConsumer interface provides a communication context that initiates
 * interaction patterns either in a synchronous or asynchronous way. The
 * resources used by each MALConsumer should be shared as long as it is possible
 * for the implementation to do it. The allowed body element types are: a) MAL
 * element types; b) MALEncodedElement; c) Java types defined by a specific Java
 * mapping extension
 *
 */
public interface MALConsumer {
    ...
    /**
     * Returns the consumers local authentication identifier used by the
     * consumer during all the interactions with the service provider
     *
    ...
    /**
     * Sets the consumers local authentication identifier used by the consumer
     ...
     *
     * @param op The operation being initiated.
     * @param body The already encoded body to transmit in the initiation
     * message
     * @return The MALMessage that was sent.
     * @throws java.lang.IllegalArgumentException If the ‘op’ argument is NULL
     * @throws MALException thrown if a non-MAL error occurs during the
    ...
    /**
     * The method initiates a synchronous INVOKE interaction. The method returns
     * as soon as the ACK message has been received.
     *
     * @param op The operation being initiated.
     * @param listener Listener in charge of receiving the messages RESPONSE and
     * RESPONSE ERROR
     * @param body The body elements to transmit in the initiation message
     * @return The MALMessage that was sent.
     * @throws java.lang.IllegalArgumentException If the ‘op’ argument is NULL
    ...
    /**
     * The method initiates a synchronous PROGRESS interaction. The method
     * returns as soon as the ACK message has been received.
     *
     * @param op The operation being initiated.
     * @param listener Listener in charge of receiving the messages UPDATE,
    ...
    /**
     * The method initiates a synchronous PubSub REGISTER interaction. The
     * method returns as soon as the ACK message has been received.
     *
     * @param op The operation being initiated.
     * @param subscription Subscription to be registered
     * @param listener Listener in charge of receiving the messages NOTIFY and
     * NOTIFY ERROR.
    ...
    /**
     * The method initiates a synchronous PubSub DEREGISTER interaction. The
     * method returns as soon as the ACK message has been received.
     *
     * @param op The operation being initiated.
     ...
     * @throws java.lang.IllegalArgumentException If the ‘op’ or 'listener'
     * arguments are NULL
     * @throws MALException thrown if a non-MAL error occurs during the
     * initiation message sending or if the MALConsumer is closed.
     * @throws MALInteractionException if a MAL standard error occurs during the
    ...
    /**
     * The method terminates all pending interaction patterns initiated by the
     * MALConsumer.
     *
