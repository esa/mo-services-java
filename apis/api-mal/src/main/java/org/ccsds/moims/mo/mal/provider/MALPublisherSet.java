...
/**
 * The MALPublisherSet class manages a set of MALPublishers that publish updates through the same PUBLISH-SUBSCRIBE
 * operation in the same domain, network zone and session with the same QoS level and priority.
 *
 */
public class MALPublisherSet
{
   ...
   * @param remotePublisherQosProps QoS properties of the PUBLISH messages, may be null.
   * @param remotePublisherPriority Priority of the PUBLISH messages, may be null.
   * @throws java.lang.IllegalArgumentException If the parameters ‘providerSet’ or ‘domain’ or ‘networkZone’ or
   * ‘sessionType’ or ‘sessionName’ are NULL
  ...
  public MALPublisherSet(final MALProviderSet providerSet,
          ...
          final UInteger remotePublisherPriority) throws java.lang.IllegalArgumentException, MALException
  {
  ...
  /**
   * The method synchronously registers through all the MALPublishers of this MALPublisherSet.
   *
  ...
  /**
   * The method ‘publish’ publishes updates through all the MALPublishers of this MALPublisherSet.
   *
  ...
  /**
   * The method synchronously deregisters through all the MALPublishers of this MALPublisherSet.
   *
   * @throws MALInteractionException If thrown by the contained MALPublishers.
   * @throws MALException If thrown by the contained MALPublishers.
   */
  ...
  /**
   * The method asynchronously registers through all the MALPublishers of this MALPublisherSet.
   *
   * @param entityKeyList Keys of the entities that are to be published
   * @param listener Listener in charge of receiving the messages PUBLISH REGISTER ACK, PUBLISH REGISTER ERROR and
   * PUBLISH ERROR
   * @return The message sent.
   * @throws java.lang.IllegalArgumentException If entityKeyList or listener are null.
   * @throws MALInteractionException If thrown by the contained MALPublishers.
   * @throws MALException If thrown by the contained MALPublishers.
   */
  ...
  /**
   * The method asynchronously deregisters through all the MALPublishers of this MALPublisherSet.
   *
