...
/**
 * The MALAccessControlFactory class enables the MAL layer to create and
 * configure MALAccessControl instances. The class provides a static factory
 * class repository that maps the MALAccessControlFactory implementation classes
 * to their class names.
 */
public abstract class MALAccessControlFactory {

    /**
     * The system property that resolves the specific MALAccessControlFactory
     * class name.
     */
     ...
     * MALAccessControlFactory. NOTE – This method may be useful in environments
