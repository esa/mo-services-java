...
/**
 * The MALInteractionHandler interface handles the interactions on the provider
 * side. The interface does not handle the PUBLISH-SUBSCRIBE REGISTER, PUBLISH
 * REGISTER, PUBLISH, DEREGISTER and PUBLISH DEREGISTER messages as they are
 * handled by a broker. A MALInteractionHandler shall be passed as a parameter
 * of the method ‘createProvider’ when creating a MALProvider. Several
 * MALProviders may use the same instance of MALInteractionHandler
 *
 */
public interface MALInteractionHandler {
     ...
     * @throws MALInteractionException If an interaction exception needs to be
     * raised.
     * @throws MALException If an error occurs.
     */
    ...
    /**
     * The method enables a MALInteractionHandler to be notified when a
