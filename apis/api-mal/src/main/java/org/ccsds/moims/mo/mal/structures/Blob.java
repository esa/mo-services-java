...
public class Blob implements Attribute
{
  ...
  /**
   * Byte array constructor, does not copy the passed array. The byte array should not be modified after the constructor
   * has been called. If the byte array is modified after the constructor has been called then the Blob behaviour is
   * unspecified.
   *
   ...
   * @throws java.lang.IllegalArgumentException If the argument is null.
   */
  public Blob(final byte[] value, final int offset, final int length) throws java.lang.IllegalArgumentException
  {
    this.value = value;
    this.uvalue = null;
    this.offset = offset;
  ...
  /**
   * URL constructor. The resource identified by the URL should not be modified until the method ‘detach’ is called. If
   * the resource identified by the URL is modified after the constructor has been called then the Blob behaviour is
   * unspecified.
   *
...
//  }
  /**
   * Return the value of this Blob as a byte array. If the Blob contains a URL then the designated content is loaded and
   * copied in the returned byte array. The returned byte array should not be modified. If the returned byte array is
   * modified then the Blob behaviour is unspecified.
   *
  ...
  /**
   * The method detaches this Blob wrapper from the resource designated by the URL when this Blob is garbaged.
   */
  public void detach()
  {
    if (null != urlValue)
