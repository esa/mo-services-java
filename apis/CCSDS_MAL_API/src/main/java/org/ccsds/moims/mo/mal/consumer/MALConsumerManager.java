...
/**
 * The MALConsumerManager interface encapsulates the resources used to enable a MAL consumer to initiate interactions.
 * The MALConsumerManager is a MALConsumer factory.
 */
public interface MALConsumerManager
{
   ...
   *
   * @param localName Name of the private MALEndpoint to be created and used by the consumer, may be NULL
   * @param uriTo URI of the service provider the consumer will interact with, may be NULL
   * @param brokerUri URI of the broker used by the service provider to publish updates, may be NULL
   * @param service Definition of the consumed service
   * @param authenticationId Authentication identifier used by the consumer during all the interactions with the service
   * provider
   ...
   * @param qosProps QoS properties that are needed to configure the QoS level, may be NULL
   ...
   * @throws java.lang.IllegalArgumentException If the parameters ‘service’, ‘authenticationId’, ‘domain’,
   * ‘networkZone’, ‘sessionType’, ‘sessionName’, ‘qosLevel’ or ‘priority’ are NULL
   ...
   * @param priority Message priority required by the consumer for all the interactions with the provider
   * @return The created MALConsumer.
   * @throws java.lang.IllegalArgumentException If the parameters 'endpoint', ‘service’, ‘authenticationId’, ‘domain’,
   * ‘networkZone’, ‘sessionType’, ‘sessionName’, ‘qosLevel’ or ‘priority’ are NULL
   * @throws MALException If the MALConsumerManager is closed
   */
  MALConsumer createConsumer(
