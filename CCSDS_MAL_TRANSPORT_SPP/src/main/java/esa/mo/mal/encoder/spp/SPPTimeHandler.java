...
public class SPPTimeHandler extends BinaryTimeHandler
{
  ...
  @Override
  public Duration decodeDuration(final BaseBinaryDecoder.BaseBinaryBufferHolder sourceBuffer) throws
      MALException
  {
  ...
  public Time decodeTime(final BaseBinaryDecoder.BaseBinaryBufferHolder sourceBuffer) throws
      MALException
  {
  ...
  public FineTime decodeFineTime(final BaseBinaryDecoder.BaseBinaryBufferHolder sourceBuffer) throws
      MALException
  {
