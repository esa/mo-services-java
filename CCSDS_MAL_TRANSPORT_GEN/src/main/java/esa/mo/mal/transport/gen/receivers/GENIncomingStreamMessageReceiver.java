...
/**
 * Extension of the GENIncomingMessageReceiverBase class for newly arrived MAL Messages in stream format.
 */
public final class GENIncomingStreamMessageReceiver extends GENIncomingMessageReceiverBase
{
   ...
   * @param ios The message input stream
   * @param receptionHandler The reception handler to pass them to.
   */
  public GENIncomingStreamMessageReceiver(final GENTransport transport, InputStream ios, GENReceptionHandler receptionHandler)
  {
