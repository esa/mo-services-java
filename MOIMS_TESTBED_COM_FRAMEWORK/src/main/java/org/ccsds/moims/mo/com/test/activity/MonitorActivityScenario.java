...
/**
 * Support for consumer side of MonitorActivity test. Supports a test in which the Consumer communicates with the
 * Provider optionally via a number of relays.
 */
public class MonitorActivityScenario extends BaseActivityScenario
{
  ...
  /**
   * Checks if Relay Management client has been created - attempts to create it.
   *
  ...
  /**
   * Initiates a test in which a MAL pattern is invoked with a list of transport & execution phases, for which the
   * corresponding activity phases shall be generated.
   *
   ...
   * @throws Exception generated in case of comms failures
   */
  public String patternInitiationForViaWithTransportActivityAndExecutionActivity(String pattern, String relay, String[] transactivity, String[] exeactivity) throws MALException, MALInteractionException
  {
    logMessage(loggingClassName + ":patternInitiationForViaWithTransportActivityAndExecutionActivity[" + pattern + "," + relay + "," + toString(transactivity) + "," + toString(exeactivity) + "]");
  ...
  /**
   * Checks the pattern completes as expected - only checks completion indication
   *
   * @param monitorKey returned by the pattern initiation method identifies pattern
   * @param transactivity - transport activities for which events should have been generated
   * @param exeactivity - transport activities for which events should have been generated
   * @return success
   */
  ...
  /**
   * For an executed pattern checks expected Activity Events have been received for transport activities
   *
   * @param monitorKey
   * @param transactivity
...
//        }
  ...
  /**
   * For an executed pattern checks expected Activity Events have been received for execution activities
   *
  ...
  /**
   * Checks if any entries in an array correspond to an error stage - contain text ERROR
   *
  ...
  /**
   * Checks if any entries in an array contain text corresponding to a transport or execution stage
   *
   ...
   * @param relay the first relay in chain - we can use broker created by this relay
   * @param hdr the MAL message header for which event to be created
   * @throws MALInteractionException
   * @throws MALException
   */
  protected void publishReleaseEvent(boolean withSuccess, String relay, MALMessageHeader hdr) throws MALInteractionException, MALException
  {
  ...
  /**
   * Used to receive responses to operations on the MonitorActivityTest service. Contains a BooleanCondition that can be
   * used to wait for completion of an operation
   */
