...
public class ZMTPChannelDestination
{
   ...
   */
  public ZMTPChannelDestination(ZMTPTransport transport, int communicationPattern, String zmtpURI)
      throws IOException
  {
        ...
        while (true) {
          ...
          try {
            ...
            if (e.getErrorCode() == ZMQ.Error.ETERM.getCode()) {
              ZMTPTransport.RLOGGER.log(Level.INFO, "ZMQ context terminated - shutting down");
            } else {
