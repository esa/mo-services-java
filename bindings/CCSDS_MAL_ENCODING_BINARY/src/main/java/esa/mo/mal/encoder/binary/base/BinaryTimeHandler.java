 ...
 *
 * It implements CCSDS Day Segmented Time Code (CDS) with P-field assumed to be "01000000" for Time
 * and "01000010" for FineTime
 */
public class BinaryTimeHandler
{
  ...
  /**
   * Converts MAL seconds timestamp to CDS with CCSDS Epoch, 16 bit day segment, 32 bit ms of day
   * segment, then writes it into the associated binary encoder
   *
   ...
   */
  public void encodeTime(final BaseBinaryEncoder.BaseBinaryStreamHolder streamHolder, Time value)
      throws MALException
  {
  ...
  /**
   * Converts MAL nanoseconds timestamp to CDS with CCSDS Epoch, 16 bit day segment, 32 bit ms of
   * day segment, 32 bit sub-ms segment, then writes it into the associated binary encoder
   *
   * @param streamHolder Associated binary encoder stream holder
  ...
  /**
   * Reads CDS with CCSDS Epoch, 16 bit day segment, 32 bit ms of day segment, then converts it into
   * a MAL seconds timestamp
   *
  ...
  /**
   * Reads CDS with CCSDS Epoch, 16 bit day segment, 32 bit ms of day segment, 32 bit sub-ms
   * segment, then converts it into a MAL nanoseconds timestamp
   *
   * @param inputBufferHolder Associated binary decoder buffer holder
