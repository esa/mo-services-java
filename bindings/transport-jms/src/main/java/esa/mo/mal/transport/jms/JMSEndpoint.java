...
public class JMSEndpoint extends GENEndpoint implements MALEndpoint {
    ...
    public JMSEndpoint(final JMSTransport transport, final String localName,
        ...
        try {
            ...
            JMSTransport.RLOGGER.log(Level.WARNING,
                    "JMS: unable to register queue name in JNDI: {0}",
                    this.queueName);
            throw e;
        }
    ...
    @Override
    protected void internalSendMessage(Object handle, boolean lastForHandle,
            GENMessage msg) throws MALTransmitErrorException {
        try {
            Session lqs = (Session) handle;
    ...
    protected void internalHandleRegister(final GENMessage msg, Session lqs) throws MALException,
        ...
        if (consumeHandlerMap.containsKey(subscriptionKey)) {
            ...
            try {
                ...
                JMSTransport.RLOGGER.log(Level.WARNING,
                        "JMS: remote topic name not found {0}", providerExchangeName);
    ...
    protected void internalHandlePublishRegister(final GENMessage msg,
    ...
    protected void internalHandlePublish(final GENMessage msg, Session lqs)
            throws MALException, MALInteractionException, MALTransmitErrorException {
    ...
    protected void internalHandleDeregister(final GENMessage msg, Session lqs)
        ...
        for (int i = 0; i < subList.size(); ++i) {
            ...
            if (consumeHandlerMap.containsKey(subscriptionKey)) {
                ...
                JMSTransport.RLOGGER.log(Level.WARNING,
                        "JMS Error deregistering for unregistered subscription {0}",
                        subscriptionKey);
            }
        }
