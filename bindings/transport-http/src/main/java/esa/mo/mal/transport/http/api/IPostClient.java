 ...
 * 
 * Actual implementations shall hide any low-level details and simply supply the functionality specified by the required
 * methods.
 */
public interface IPostClient {

  /**
   * Placeholder to use for empty string header values instead, in order to be sure that the header field will be
   * transmitted and not dropped.
   */
   ...
   * 
   * @param remoteUrl
   *            the remote URL the client connects to
   * @param useHttps
   ...
   *             in case an error occurs when initialising or connecting the client
   */
   ...
   * 
   * @param data
   *            the optional data bytes to be transmitted
   * @throws HttpApiImplException
   *             in case an error occurs when writing the request body
   */
   ...
   * 
   * @throws HttpApiImplException
   *             in case an error occurs when sending the request
   */
   ...
   * @throws HttpApiImplException
   *             in case an error occurs when reading the status-code
   */
   ...
   * @throws HttpApiImplException
   *             in case an error occurs when reading the response body
   */
   ...
   * 
   * @throws HttpApiImplException
   *             in case an error occurs when shutting down the client
   */
