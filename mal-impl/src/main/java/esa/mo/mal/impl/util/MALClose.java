...
/**
 * Base class that tracks children classes and its parent class and supports the concept of being closed. Closing this
 * class informs the parent we are being closed and also all children that they should close also.
 *
 */
public class MALClose
{
  ...
  /**
   * Closes this class, informs all children that we are being closed and they should also, and then informs our parent
   * (if we have one) that we are closing.
   *
  ...
  /**
   * This should be overridden by any implementing class to provide the actual close functionality of this class.
   *
   * @throws MALException If an error occurs, implementations should throw a MALException.
   */
