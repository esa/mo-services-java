 ...
 */
public class TCPTransportFactoryImpl extends MALTransportFactory
{
   ...
   */
  public TCPTransportFactoryImpl(final String protocol)
  {
    super(protocol);
  }
  ...
  public MALTransport createTransport(final MALContext malContext, final Map properties) throws MALException
  {
    synchronized (MUTEX)
    {
      if (null == transport)
      {
        transport = new TCPTransport(getProtocol(), this, properties);
        transport.init();
      }
