...
/**
 * The Parameter service implementation, provider side.
 */
public class ParameterProviderServiceImpl extends ParameterInheritanceSkeleton {

    private static final Logger LOGGER = Logger.getLogger(ParameterProviderServiceImpl.class.getName());
    ...
    public synchronized void init(ParameterBackend backend) throws MALException {
        ...
        service = connection.startService(ParameterHelper.PARAMETER_SERVICE, false, this);
        running = true;
        LOGGER.info("Parameter service READY");
    }
