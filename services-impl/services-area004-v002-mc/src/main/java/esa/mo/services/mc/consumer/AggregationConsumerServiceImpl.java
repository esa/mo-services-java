...
/**
 * The Aggregation service implementation, consumer side.
 */
public class AggregationConsumerServiceImpl extends ConsumerServiceImpl {
     ...
     */
    public AggregationConsumerServiceImpl(final SingleConnectionDetails connectionDetails) throws MALException {
     ...
     * @throws MALException If the service could not be started.
     */
    public AggregationConsumerServiceImpl(final SingleConnectionDetails connectionDetails,
        ...
        if (tmConsumer != null) {
            try {
                ...
                Logger.getLogger(AggregationConsumerServiceImpl.class.getName()).log(
                        Level.SEVERE, "The previous connection could not be closed!", ex);
            }
        }

        tmConsumer = connection.startService(connectionDetails,
                AggregationHelper.AGGREGATION_SERVICE, authenticationId, localNamePrefix);
