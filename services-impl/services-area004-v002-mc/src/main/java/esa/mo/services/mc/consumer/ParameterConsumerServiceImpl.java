...
/**
 * The Parameter service implementation, consumer side.
 */
public class ParameterConsumerServiceImpl extends ConsumerServiceImpl {
     ...
     * @throws MALException If the service could not be started.
     */
    public ParameterConsumerServiceImpl(final SingleConnectionDetails connectionDetails,
        ...
        tmConsumer = connection.startService(connectionDetails,
                ParameterHelper.PARAMETER_SERVICE, authenticationId, localNamePrefix);
