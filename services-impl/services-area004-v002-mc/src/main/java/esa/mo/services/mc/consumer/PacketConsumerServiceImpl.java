...
/**
 * The Packet service implementation, consumer side.
 */
public class PacketConsumerServiceImpl extends ConsumerServiceImpl {

    private PacketStub packetService = null;
     ...
     */
    public PacketConsumerServiceImpl(final SingleConnectionDetails connectionDetails) throws MALException {
     ...
     * @throws MALException If the service could not be started.
     */
    public PacketConsumerServiceImpl(final SingleConnectionDetails connectionDetails,
        ...
        if (tmConsumer != null) {
            try {
                ...
                Logger.getLogger(PacketConsumerServiceImpl.class.getName()).log(
                        Level.SEVERE, "The previous connection could not be closed!", ex);
            }
        }

        tmConsumer = connection.startService(connectionDetails,
                PacketHelper.PACKET_SERVICE, authenticationId, localNamePrefix);

        this.packetService = new PacketStub(tmConsumer);
    }

    @Override
    public Object generateServiceStub(MALConsumer tmConsumer) {
        return new PacketStub(tmConsumer);
    }

    @Override
    public Object getStub() {
        return this.getPacketStub();
    }
     ...
     */
    public PacketStub getPacketStub() {
