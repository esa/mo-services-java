 ...
 */
public class FixedBinaryListDecoder implements MALListDecoder {
     ...
     */
    public FixedBinaryListDecoder(final List list, final BufferHolder sourceBuffer) throws MALException {
        this.list = list;
